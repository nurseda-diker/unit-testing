...
namespace Demo.Tests
{
    ...
    public class GruplayiciTests
    {
        ...
        [TestMethod]
        public void bir_elemanli_liste_birerli_gruplanmak_istediginde_grup_sayisi_bir_olmalidir()
        {
            var olcumler = OlcumListesiOlustur(1);
        ...
        [TestMethod]
        public void alti_elemanli_liste_ikişerli_gruplanmak_istediginde_grup_sayisi_uc_olmalidir()
        {
        ...
        [TestMethod]
        public void elli_elemanli_liste_onarli_gruplanmak_istediginde_grup_sayisi_bes_olmalidir()
        {
